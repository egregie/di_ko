...
## Metadata
- **Current Phase**: Phase 1.5: Evidence Audit (Ground-Truth Gate)
- **Status**: Completed / tag `phase-1.5-audit`
...
- **Phase 1.5 (Evidence Audit: Ground-Truth Gate)**: Completed. Audited 16 facts against live PubMed abstract API. 4 unsupported facts quarantined to `rejected/`, 3 weak facts adjusted to confidence 0.80, and index compiled. Validator passes with 0 errors.

...
- **Gemini daily quota (2026-06-11)**: the free-tier judge key hit 429 RESOURCE_EXHAUSTED (PerDay) after the Postacne batch. `fact_0074` deferred until quota resets. Heavy verification batches should be paced or use a paid key.

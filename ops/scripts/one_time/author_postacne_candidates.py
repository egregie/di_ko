...
ROWS = [
    ("fact_0063",
     "Topical 15% azelaic acid gel significantly reduces acne-induced post-inflammatory erythema and post-inflammatory hyperpigmentation, decreasing hemoglobin and melanin content with minimal adverse reactions",
    ...
    ("fact_0064",
     "A systematic review of randomized controlled trials found topical azelaic acid is more effective than vehicle for acne and melasma and is generally well tolerated",
    ...
    ("fact_0066",
     "Topical niacinamide inhibits melanosome transfer from melanocytes to keratinocytes and significantly decreases facial hyperpigmentation compared with vehicle",
    ...
    ("fact_0068",
     "Meta-analysis found combining microneedling with chemical peeling is superior to either treatment alone for atrophic acne scars, with mild and transient adverse events",
    ...
    ("fact_0072",
     "In a split-face study both 70 percent glycolic acid and 30 percent trichloroacetic acid peels significantly reduced facial atrophic acne scars, with the trichloroacetic acid side showing greater improvement",
    ...
    ("fact_0074",
     "Azelaic acid acts as a tyrosinase inhibitor with antimelanogenic activity and is used to treat hyperpigmentation disorders such as melasma and post-inflammatory hyperpigmentation",
